...
int main(int argc, char **args)
{
    ...
    //Loader server IP
    addrs[0] = inet_addr("192.168.1.6"); // Address to bind to
    addrs[1] = inet_addr("192.168.1.6"); // Address to bind to
#endif
    ...
    char http_ip[] = "192.168.1.6";  //HTTP server IP
    char tftp_ip[] = "192.168.1.6";  //TFTP server IP
    if ((srv = server_create(sysconf(_SC_NPROCESSORS_ONLN), addrs_len, addrs, 1024 * 64, http_ip, 80, tftp_ip)) == NULL)
    {
